...
@Component({
  selector: 'app-item-page-top-left',
  templateUrl: './item-page-top-left.component.html',
  styleUrls: ['./item-page-top-left.component.css']
})
export class ItemPageTopLeftComponent implements OnInit {
