...
<div>
    ...
    <h5><strong><%=authorizationPageBeanId.getLocalization(application).getString("help")%></strong></h5>
      <div class="body">
		...
		<%=catalogListBeanId.getCatalogUrlPath("Co2ProductPost.jsp",authorizationPageBeanId)%>
		</div>
		</div>
		</div>
       ...
       <!--  list catalog  -->
		<div class="box">
		  <div class="body">
		    <div >
	         <%=publisherBeanId.getAction().equals("")?catalogListBeanId.getNavigator("Co2ProductPost.jsp",authorizationPageBeanId):""%>
     	     <%=publisherBeanId.getAction().equals("add")?catalogAddBeanId.getAddFormWithJsp("Co2ProductPost.jsp"):""%>
	         <%=publisherBeanId.getAction().equals("edit")?catalogEditBeanId.getEditForm(catalogListBeanId.rows[catalogEditBeanId.getIndx_select()][0] , catalogListBeanId.rows[catalogEditBeanId.getIndx_select()][1],"Co2ProductPost.jsp"):""%>
      ...
      <form method="post" name="postsoftform"  ACTION="Co2ProductPost.jsp" onSubmit="return  IsFormOk()"  >
      <!-- 
      <br/>
		<br/>
		<div class="box">
