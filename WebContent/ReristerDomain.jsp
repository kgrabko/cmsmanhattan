		    ...
		    <div >
				...
				<table width="670"    border="0" cellspacing="0" cellpadding="5" bgcolor="#DFE3EF">
                    ...
                    <tr>
						...
						<input type="text" size="70" name="period" value="12"  />  
						<input type="text" size="70" name="status" value=""  />  
						<input type="text" size="70" name="owner-c" value=""  />  
						<input type="text" size="70" name="billing-c" value=""  />  
