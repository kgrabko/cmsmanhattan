...
<table class="columns">
    ...
    <tbody>
        ...
        <form method="post" name="postsoftform"  ACTION="ProductUserPostBusiness.jsp" onSubmit="return  IsFormOk()"  >
		<br/>
		<br/>
		<div class="box">
		  <div class="body">
		  ...
		  <div class="body">
		    <div >
				...
				<A  onclick="switchWindowInputForm()" href="#" > <IMG id='input_form'  title="<%= authorizationPageBeanId.getLocalization(application).getString("Expand") %>" src="images/expand.gif" align="right"/> </A>
					<font color='white' size='2' >&nbsp; <%=authorizationPageBeanId.getLocalization(application).getString("step2")%> .&nbsp;&raquo; <%=authorizationPageBeanId.getLocalization(application).getString("title_form_post_info")%></font>
				</DIV>
				<br/>
