    ...
    <h5><strong>Помощ</strong></h5>
      <div class="body">
        <div class="portletContent odd">
         Это форма для добавления вашей ссылки на фильм .
        </div>
        <div class="portletContent even">
		Здесь можно добавлять свои ,
		ссылки на фильм для обмена фильмами .
        </div>
      </div>
    </div>
</div>
	    ...
	    <h1>Написать сообщение на о фильме</h1>
<br/>
		  ...
		  <div class="body">
		    <div >
                  <form method="post" name="postsoftform"  ACTION="BlogExtProductPost.jsp" onSubmit="return  IsFormOk()"  >
					...
					<font color='white' size='2' > &nbsp;&raquo; Форма для заведения или изменения этой информации на форуме нашего портала </font>
					</DIV>
                     <div >
                     <TABLE width="500" >
