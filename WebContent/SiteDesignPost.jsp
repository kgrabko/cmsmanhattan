...
<table class="columns">
    ...
    <tbody>
      ...
      <!--  end  list catalog  -->
		...
		<br/>
        <form method="post" name="postsoftform"  ACTION="ProductPostCre.jsp" onSubmit="return  IsFormOk()"  >
		<!-- 
		<br/>
		<br/>
		<div class="box">
		...
		<div class="box">
		  <div class="body" >
		    <div >
		    <DIV style="background-image:url('images/f.jpg');height:20px; TEXT-ALIGN: left"  >
				<font color='white' size='2' > &nbsp;&raquo; Attach Web Site jar archive to deploy new skin for Web site. </font>
			</DIV>
                     <TABLE>
