...
<table class="columns">
    ...
    <tbody>
		...
		<%=catalogListBeanId.getCatalogUrlPath("Co1ProductPostUser.jsp",authorizationPageBeanId)%>
		</div>
		</div>
		</div>
       ...
       <!--  list catalog  -->
		<div class="box">
		  <div class="body">
		    <div >
	         <%=publisherBeanId.getAction().equals("")?catalogListBeanId.getNavigator("Co1ProductPostUser.jsp",authorizationPageBeanId):""%>
     	     <%=publisherBeanId.getAction().equals("add")?catalogAddBeanId.getAddFormWithJsp("Co1ProductPostUser.jsp"):""%>
	         <%=publisherBeanId.getAction().equals("edit")?catalogEditBeanId.getEditForm(catalogListBeanId.rows[catalogEditBeanId.getIndx_select()][0] , catalogListBeanId.rows[catalogEditBeanId.getIndx_select()][1],"Co1ProductPostUser.jsp"):""%>
      ...
      <form method="post" name="postsoftform"  ACTION="Co1ProductPostUser.jsp" onSubmit="return  IsFormOk()"  >
