...
<div>
    ...
    <h5><strong>Помощ</strong></h5>
      <div class="body">
		...
		<%=catalog_listBean.getCatalogUrlPath("Co2ProductPostUser.jsp",AuthorizationPageBeanId)%>
		</div>
		</div>
		</div>
       ...
       <!--  list catalog  -->
		<div class="box">
		  <div class="body">
		    <div >
	         <%=SoftPostBeanId.getAction().equals("")?catalog_listBean.getNavigator("Co2ProductPostUser.jsp",AuthorizationPageBeanId):""%>
     	     <%=SoftPostBeanId.getAction().equals("add")?catalog_addBean.getAddFormWithJsp("Co2ProductPostUser.jsp"):""%>
	         <%=SoftPostBeanId.getAction().equals("edit")?catalog_editBean.getEditForm(catalog_listBean.rows[catalog_editBean.getIndx_select()][0] , catalog_listBean.rows[catalog_editBean.getIndx_select()][1],"Co2ProductPostUser.jsp"):""%>
