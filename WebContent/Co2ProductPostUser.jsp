...
%>
<% // Old page So use SponsoredBySellersItemPostUser.jsp  %>
<html>
<head>
...
<div>
    ...
    <h5><strong>Помощ</strong></h5>
      <div class="body">
		...
		<%=catalogListBeanId.getCatalogUrlPath("Co2ProductPostUser.jsp",authorizationPageBeanId)%>
		</div>
		</div>
		</div>
       ...
       <!--  list catalog  -->
		<div class="box">
		  <div class="body">
		    <div >
	         <%=publisherBeanId.getAction().equals("")?catalogListBeanId.getNavigator("Co2ProductPostUser.jsp",authorizationPageBeanId):""%>
     	     <%=publisherBeanId.getAction().equals("add")?catalogAddBeanId.getAddFormWithJsp("Co2ProductPostUser.jsp"):""%>
	         <%=publisherBeanId.getAction().equals("edit")?catalogEditBeanId.getEditForm(catalogListBeanId.rows[catalogEditBeanId.getIndx_select()][0] , catalogListBeanId.rows[catalogEditBeanId.getIndx_select()][1],"Co2ProductPostUser.jsp"):""%>
      ...
      <form method="post" name="postsoftform"  ACTION="Co2ProductPostUser.jsp" onSubmit="return  IsFormOk()"  >
