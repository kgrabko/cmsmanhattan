...
<table class="columns">
    ...
    <div class="box">
        <div class="body">
            ...
            <div class="even"> 
                <a href="">
			<img src="xsl/vityazka.gvidons.net/img/linkTransparent.gif" alt="Link icon" title="Link icon" height="11" width="6" border="0" />
...
...
	    ...
	    <div class="description"><img src="xsl/vityazka.gvidons.net/img/basket1.gif"/>Введите номер заказа <FORM name="order" action="Order.jsp" ><INPUT SIZE="0"  AUTOCOMPLETE="off" TYPE="TEXT" NAME="order_id"><xsl:attribute name="value"><xsl:value-of select="document/list/order/order_id"/></xsl:attribute></INPUT><INPUT TYPE="submit" name="submit" value="Найти"></INPUT></FORM></div>
