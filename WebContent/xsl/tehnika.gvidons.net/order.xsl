...
<div>
	...
	<strong>3.</strong>   Интернет магазин работает в режиме тестирования, поэтому оплата не работает.
	    ...
	    <div class="description">Ваша корзина<img src="xsl/tehnika.gvidons.net/img/basket1.gif"/></div>
	    ...
	    <div class="description">Дополнительные расходы<img src="xsl/tehnika.gvidons.net/img/basket1.gif"/></div>
...
<FORM name="order" action="Order.jsp" >
	    ...
	    <div class="description">Адрес доставки<img src="xsl/tehnika.gvidons.net/img/basket1.gif"/></div>
