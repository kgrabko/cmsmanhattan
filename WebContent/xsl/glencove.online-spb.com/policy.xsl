...
<div id="container">
<div class="comp-cont"  style="background-color: #CFCFC8; text-align: left; PADDING-BOTTOM:0px ; margin-bottom: 3px"  >
...
<!-- 												
	 ...
	 -->												   	    						
		...
		<tr >
			...
			<img alt="Link icon" title="Link icon" height="20" width="50" border="0" style="margin-right: 5px">
           		<xsl:attribute name="src"><xsl:value-of select="concat('xsl/',$host,'/images/searchButton.gif')"/></xsl:attribute>
            </img>
	   ...
	   <tr>
		...
		<tr > 
		 <td >
		  ...
		  <DIV class="module_forum" style="margin:0 0 0px; background: transparent url(images/box-title-bg-forum.gif) repeat-y scroll 0 0;">
