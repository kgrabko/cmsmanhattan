		...
		<table class="blog" cellpadding="0" cellspacing="0">
			...
			<td valign="top">
				<div class="article-bg_">
						...
						<div class="article-right_">
	                        ...
	                        <DIV>							
												...
												<TABLE class="contentpane aut" cellSpacing="0" cellPadding="0" border="0">															    													
					                       					...
					                       					<TR><TD style="height: 30px;" >Country*</TD>
				                       						<TD align="left"  >
				                       						<SELECT style="width: 260px;height: 24px"  NAME = "country_id" onChange="doChangeCity('country_id', this.value)"  id="country_id">
											            ...
											            <TR><TD style="height: 30px;" >City*</TD>
											            	<TD align="left" >
												                <SELECT style="width: 260px;height: 24px"  NAME = "city_id" id="city_id">
					...
					<tr><td style="height: 30px;"> Address*</td><td align="left" ><INPUT SIZE="40" style="width: 260px; height: 25px;"  AUTOCOMPLETE="off" TYPE="TEXT" NAME="shipment_address"  id="shipment_address"><xsl:attribute name="value"><xsl:value-of select="document/shipment_address"/></xsl:attribute></INPUT></td></tr>
					<tr><td style="height: 30px;" > Phone* </td><td align="left" ><INPUT SIZE="40" style="width: 260px; height: 25px;"   AUTOCOMPLETE="off" TYPE="TEXT" NAME="shipment_phone"  id="shipment_phone"><xsl:attribute name="value"><xsl:value-of select="document/shipment_phone"/></xsl:attribute></INPUT></td></tr>
					<tr><td style="height: 30px;"> Contact name* </td><td align="left" ><INPUT SIZE="40" style="width: 260px; height: 25px;"   AUTOCOMPLETE="off" TYPE="TEXT" NAME="contact_person"  id="contact_person"><xsl:attribute name="value"><xsl:value-of select="document/contact_person"/></xsl:attribute></INPUT></td>	</tr>
					<tr><td style="height: 30px;"> E-Mail *</td><td align="left" ><INPUT style="width: 260px; height: 25px;"   title="On this e-mail the account will be sent" SIZE="40" AUTOCOMPLETE="off" id="shipment_email" TYPE="TEXT" NAME="shipment_email"  ><xsl:attribute name="value"><xsl:value-of select="document/shipment_email"/></xsl:attribute></INPUT></td></tr>
					<tr><td style="height: 30px;" > Fax</td><td align="left" ><INPUT SIZE="40" style="width: 260px; height: 25px;"   AUTOCOMPLETE="off" TYPE="TEXT" NAME="shipment_fax"  ><xsl:attribute name="value"><xsl:value-of select="document/shipment_fax"/></xsl:attribute></INPUT></td></tr>
					<tr><td> Comments </td><td align="left" ><textarea style="width: 260px;"  rows="10" NAME="shipment_description"><xsl:value-of select="document/shipment_description"/></textarea></td></tr>

					<tr><td> </td><td align="left" ><br/></td></tr>
