...
<br />
	...
	<div class="box">
	  <div class="body">
	    <div class="content even"> <img src="xsl/plita.gvidons.net/img/logo5.jpg" border="0" ><font size="3"><b> Интернет магазин <xsl:value-of select="document/site_name"/></b></font></img></div>
	  </div>
	</div>
...
<table class="columns">
    ...
    <div class="box">
        <div class="body" >
            ...
            <div class="even"> 
                <a href="">
                   <img src="xsl/plita.gvidons.net/img/user.gif" alt="Link icon" title="Link icon" height="20" width="20" border="0" />
...
<div>
	...
	<div class="box">
	  <div class="body">
		...
		<IMG border="0" height="20" name="Nindex_14_03" src="xsl/plita.gvidons.net/img/user.gif" width="20"/>
...
onmouseout="&#13;&#10;&#9;&#9;&#9;&#9;&#9;&#9;&#9;&#9;style.backgroundColor='#EFEFEF'"
  hight="60" align="left" bgColor="#EFEFEF"  >
			                 <A><xsl:attribute name="HREF"><xsl:value-of select="url"/></xsl:attribute><IMG border="0" height="14" name="Nindex_14_03" src="xsl/plita.gvidons.net/dir.gif" width="15"></IMG><STRONG><FONT size="2" color="#103d43">.<xsl:value-of select="item"/></FONT></STRONG></A> 
				            </TD></TR>   	          		
				    </xsl:for-each>
	...
	<div class="box">
	  <div class="body">
	    <div class="even" align="left" ><br/><IMG border="0" height="20" name="Nindex_14_03" src="xsl/plita.gvidons.net/img/user.gif" width="20"></IMG> Вы можете перевести денежные средства в магазин для оплаты заказа, используя кредитные карты или виртуальные кошельки, такие как Web money , Яндекс деньги , E-Port и другие  <br/><br/>
