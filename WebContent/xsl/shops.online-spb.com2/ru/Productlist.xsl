...
<head>
     ...
     <meta name="keywords" content="интернет магазин бесплатно, интернет магазин бесплатный, бесплатный интернет магазин, готовый интернет магазин, готовый бесплатный интернет магазин, готовый интернет магазин бесплатно, интернет магазин, интернет-магазин, свой интернет магазин, свой интернет магазин бесплатно, свой бесплатный интернет магазин, аренда интернет магазина, интернет магазин в аренду, бесплатный сайт, сайт бесплатно, готовый сайт, готовый бесплатный сайт, готовый сайт бесплатно, как создать интернет магазин, как создать интернет магазин бесплатно, как создать сайт, как создать сайт бесплатно, создание интернет магазина, создание интернет магазина бесплатно, создать интернет магазин бесплатно, Москва , Санкт-Петербург"/>
     <meta name="description" content="Готовое бесплатное решение интернет магазина одним нажатием. Хостинг. Поддержка. Продвижение. Сопровождение. "/>
...
<TR>
	...
	<div>
		  ...
		  <TR>
		    ...
		    <a  onclick="this.style.behavior='url(#default#homepage)'; this.setHomePage('http://www.siteoneclick.com'); return false;" href="#" ></a> <a href="javascript:window.external.AddFavorite('http://www.siteoneclick.com','www.siteoneclick.com')" ><font color="white" > <b>Добавить в избранное</b></font> </a> <br/><font color="white" > <b>+1(516)777-0945</b></font><br/><font color="white" > <b></b></font> 
			  ...
			  <form name="searchform"  action="Productlist.jsp" >
	            ...
	            <input class="searchButton"  type="button" size="20" value="Поиск"  tabindex="30002" onClick="return top.search_word();return true"   />
	          </form>
			  <br/>
			</TD>
		  </TR>
        ...
        <A href="Domain.jsp" class="plain"><font size="2">Регистрация доменов</font></A>

<!--        <A href="http://companies.siteoneclick.com" class="plain"><font size="2">Наши клиенты</font></A>  -->
	 <A href="webmail/" class="plain"><font size="2">Почта</font></A> 		<a href="Policy.jsp?page=about" class="plain"><font size="2"> О компании</font></a>
	...
	<!--
		...
		<a href="ProductUserPost.jsp?parent_id=0"  class="plain" ><font size="2"> Добавить ресурс </font> </a>  
           </xsl:if>
           </xsl:if>
	-->
       ...
       <!--    <a href="Productlist.jsp?catalog_id=-2" class="selected" ><font size="2"> Справочник Колпино  </font> </a> -->

       <!--  показывать если нет логина -->
       <!--
           <xsl:if test="document/login = 'user'">   
           <A href="Authorization.jsp?Login=" class="plain" ><font size="2"> Регистрация </font> </A>
	   </xsl:if>
       -->
       ...
       <!--
           ...
           <xsl:if test="/document/role_id = '1'">
	 	    <xsl:choose> 
				       ...
				       <a href="Productlist.jsp?action=create_site" class="plain" ><font size="2"> Добавление ресурса - вход </font> </a>
			   </xsl:when> 

			   <xsl:otherwise>
				<a href="Productlist.jsp?action=login_usersite" class="plain" ><font size="2"> Добавление ресурса - вход </font> </a>
                           </xsl:otherwise> 
		...
		<a href="Productlist.jsp?action=logoff_usersite" class="plain" ><font size="2"> Выход из режима добавлений </font> </a>   
           ...
           <xsl:if test="/document/site_id = '2'">
           	<xsl:if test="/document/role_id = '2'" >
		<a href="Productlist.jsp?catalog_id=-4" class="plain" ><font size="2">Поступившие объявления</font> </a>
		<a href="Productlist.jsp?catalog_id=-5" class="plain" ><font size="2">Отклоненные объявления</font> </a>
	        </xsl:if>
           </xsl:if>
	...
	-->
	   ...
	   <a href="Productlist.jsp?locale=ru">
                <img alt="Link icon" title="Русский" height="13" width="16" border="0">
					  ...
					  <div class="box"  >
					      <div style="height:21px;width:159px; TEXT-ALIGN: left" class="bacgraundBoxTitle"  >
					           ...
					           <TABLE class="text"  height="20" cellSpacing="4" cellPadding="0" width="100%"  >
					              <TBODY>
					              <TR>
					                <TD vAlign="center" ><FONT color="white" ><B><!--Реклама--></B></FONT>
					               </TD>
					              </TR>
					  	     </TBODY>
					  	   </TABLE>
			           ...
			           <tr><td><br/></td></tr>
			            ...
			            <!-- News Iten end -->
			              ...
			              <TR>
			                <TD colspan="3" align="right" width="155"  colSpan="3" style="padding-right: 15px" ><A class="menu"  title="Все новости" 
			                  href="Productlist.jsp?catalog_id=-6"><FONT  class="text" ><U>Новые поступления</U></FONT></A>
							 </TD>
			              </TR>
					 ...
					 <div class="box"  >
					      <div style="height:21px;width:159px; TEXT-ALIGN: left"  class="bacgraundBoxTitle" >
					           <TABLE class="text"  height="20" cellSpacing="4" cellPadding="0" width="100%"  >
					              <TBODY>
					              <TR>
					                <TD vAlign="center" ><FONT color="white" ><B>Новости компании</B></FONT></TD>
					              </TR>
					  	     	  </TBODY>
					  	       </TABLE>
					      </div>
										        ...
										        <tr>											    
									        	    <td valign="center"   align="center"  width="100%" height="100">										        	    
														<A>
															...
															<xsl:attribute name="title"><xsl:value-of select="rigth/name"/> - выбираю этот дизайн </xsl:attribute>
									        ...
									        <tr>										    
								        	    <td  align="center"  width="100%" >								        	    	 
													<A>
														...
														<xsl:attribute name="title"><xsl:value-of select="left/name"/>- выбираю этот дизайн</xsl:attribute>
														<IMG  alt=""  width="290" border="0">
		        					...
		        					<xsl:if test="left/product_id != ''">
								         <td class="buttons-line">							         	 
									        <form name="product_edit"  action="Productlist.jsp" style="float: left">
												...
												<INPUT TYPE="submit" name="submit" value="Изменить" style="float: left"></INPUT>
									        </form>
								        
									        <form name="product_del"  action="Productlist.jsp" style="float: left; margin-left: 5px">
												<INPUT SIZE="0"  AUTOCOMPLETE="off" TYPE="HIDDEN" NAME="action" VALUE="del"  ></INPUT>
												<INPUT SIZE="0"  AUTOCOMPLETE="off" TYPE="HIDDEN" NAME="product_id"><xsl:attribute name="value"><xsl:value-of select="left/product_id"/></xsl:attribute></INPUT>
												<INPUT TYPE="submit" name="submit" value="Удалить" style="float: left"></INPUT>
									        </form>								       							    
								         </td>
							         </xsl:if>							         
							        </tr>
					               ...
					               <xsl:if test="rigth/user_id = string(number($user_id))" >
							          ...
							          <td nowrap="nowrap" class="buttons-line"> 
							                ...
							                <form name="product_up_position"  action="Productlist.jsp" style="float: left">
												...
												<INPUT SIZE="0"  AUTOCOMPLETE="off" TYPE="HIDDEN" NAME="product_id"><xsl:attribute name="value"><xsl:value-of select="rigth/product_id"/></xsl:attribute></INPUT>
												<INPUT TYPE="submit" name="submit" value="Поднять"></INPUT>
							                </form>
							                ...
							                <form name="product_set_color"  action="Productlist.jsp" style="float: left">
												...
												<INPUT SIZE="0"  AUTOCOMPLETE="off" TYPE="HIDDEN" NAME="product_id"><xsl:attribute name="value"><xsl:value-of select="rigth/product_id"/></xsl:attribute></INPUT>
												<INPUT TYPE="submit" name="submit" value="Подкрасить"></INPUT>
							                </form>
							                -->
							         </td>
...
<input type="submit" value="Пополнить картой"  border="0" name="submit" alt="Пополнить счет кредитной картой через PayPal."/>
</form>
	  ...
	  <br/>
	   <div>
	             ...
	             <TBODY>
	             <TR>
	                <TD vAlign="rigth" ><FONT color="white" ><B>Разделы</B></FONT></TD>
	              </TR>
	  	     </TBODY>
	  	   </TABLE>
...
<div class="footer">
 ...
 <DIV id="vunet"  class="drag" style="position: absolute; top: 220px; left: 430px;display:none;"  >
	...
	<font  color='white' size='2' > <b id="title_name" > GBS Portal - Поиск во всех поисковых системах </b> </font>
	</DIV>
...
function AgentIntro()
{
   ...
   Agent.Show(0);
    ...
    Agent.Play("Announce");
    Agent.Play("Wave");
    Agent.Speak("]]> Привет! Молодец, что заглянул ко мне.<![CDATA[ ");

    Agent.MoveTo(745,64);
    Agent.Speak("]]>Что-нибудь ищешь?<![CDATA[ ");
    Agent.Play("DoMagic1");
    Agent.Play("DoMagic2");
    Agent.Speak("]]>Сейчас посмотрим!<![CDATA[ ");
    Agent.Play("Search");
    Agent.Speak("Вижу, что сайтами интересуешься.");

    Agent.MoveTo(845,300);
    Agent.Speak("Я тебе помогу.");
    Agent.Play("Congratulate_2");
    Agent.Play("Read");
    Agent.Speak("Здесь можно получить сайт или интернет-магазин с хостингом и поддержкой.");
    Agent.Play("Read");
    Agent.Speak("И платить только за просмотр страницы с подробной информацией. Страницы с краткой информацией не тарифицируются.");

    Agent.MoveTo(835,500);
    Agent.Play("GetAttention");
    Agent.Play("GetAttention");
    Agent.Speak("И скажу тебе по большому секрету - стоимость одной открытой страницы всего 10 копеек.");
    Agent.Speak("Да! Забыл предупредить. Тебя ждет приз.");
    Agent.Play("Congratulate");
    Agent.Speak(" А именно - почтовый яшик.");

    Agent.MoveTo(5,300);
    Agent.Speak("Живу здесь, как в сказке.");
    Agent.Play("DoMagic1");
    Agent.Play("DoMagic2");
    Agent.Speak("Каждый день появляются новые сайты и интернет-магазины.");
	Agent.Play("DoMagic2");
    Agent.Speak("Ведь здесь это просто.");
	Agent.Play("DoMagic2");
    Agent.Speak("Достаточно зарегистрироваться, выбрать дизайн из базы дизайнов и нажать кнопку *Создать магазин*.");
    Agent.Play("Surprised");
    Agent.Speak("Извини, кто-то еще зашел, надо встретить.");
    Agent.Play("Wave");
    Agent.Speak("]]> Еще увидимся.<![CDATA[ ");

/*
    Agent.MoveTo(446,34);
    Agent.Play("Announce");
    Agent.Play("Wave");
    Agent.Speak("]]> Привет, Старичок! Молодец, что заглянул ко мне.<![CDATA[ ");

    Agent.MoveTo(38,169);
    Agent.Play("Search");
    Agent.Speak("Вижу, что фильмами интересуешься.");

    Agent.MoveTo(24,333);
    Agent.Play("Read");
    Agent.Speak("Здесь много можно найти.");

    Agent.MoveTo(23,445);
    Agent.Play("Read");
    Agent.Speak("В хорошем качестве.");

    Agent.Play("Congratulate");
    Agent.Play("Surprised");
    Agent.Speak("И абсолютно бесплатно.");
    
    Agent.Play("Surprised");
    Agent.Speak("Также каждый может получить почтовый ящик.");

    Agent.MoveTo(47,373);
    Agent.Play("GetAttention");
    Agent.Play("GetAttention");
    Agent.Play("GetAttention");
    Agent.Speak("Ладно, пойду я,");

    Agent.MoveTo(48,255);
    Agent.Play("DoMagic1");
    Agent.Play("DoMagic2");
    Agent.Speak("кто-то еще зашел, надо встретить.");
    Agent.MoveTo(52,99);
    Agent.Play("Announce");
    Agent.Speak("Заходи еще, буду рад.");
...
// -->
        ...
        <xsl:template match="product">
  		<!-- Создается элемент book -->
		<book>
			<!-- Создается элемент title и извлекается его значение -->
			<title><xsl:value-of select="./title"/></title>
			<!-- Создается элемент price и извлекается его значение -->
