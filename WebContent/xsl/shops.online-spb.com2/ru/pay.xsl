...
<!--		<FORM ACTION="https://pgate.grabko.com:443/authorizationPay.do" METHOD="POST">  -->
	...
	<div class="box">
	  <div class="body">
	    <div class="even" align="left" ><br/><IMG border="0" height="20" name="Nindex_14_03" src="images/user.gif" width="20"></IMG> Вы можете перевести денежные средства в магазин для оплаты заказа, используя кредитные карты или виртуальные кошельки, такие как Web money , Яндекс деньги , E-Port и другие  <br/><br/>
...
Product Internet shop builder . Copyright 2005 <A HREF="http://www.siteoneclick.com">Center Business Solutions Inc</A> . Все права защищены.<hr size="" class="netscape4" />
