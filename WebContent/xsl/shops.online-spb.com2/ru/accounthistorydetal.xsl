...
<br/>
		  ...
		  <div class="body">
			...
			<table >
			    <tbody>
	                       ...
	                       <TR><TD><IMG height="80" alt=""  width="80" border="0"  src="xsl/reservation.gvidons.net/img/index_00.gif"></IMG></TD><TD></TD><TD></TD><TD></TD><TD></TD><TD></TD></TR> 
			    </tbody>
			</table>
	...
	<div class="box">
	  <div class="body">
	    <div class="content even" align="left" >
		<A><xsl:attribute name="HREF"><xsl:value-of select="document/to_order"/></xsl:attribute><IMG border="0"  name="Nindex_14_03" src="images/user.gif" height="20"  width="20"></IMG>Заказ</A>
	    </div>
	  </div>
	</div>
