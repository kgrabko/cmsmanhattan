		  ...
		  <div class="body">
			...
			<table >
			    <tbody>
	                       ...
	                       <TR><TD width="100%"  colspan="2" ><h4>IP Адресс клиента <xsl:value-of select="document/payment/user_ip"  /></h4></TD></TR>
	                       ...
	                       <TR><TD><h4>Статуc выполнения операции </h4></TD><TD width="60%" ><h4> <xsl:if test="document/payment/complete = 't'"> <STRONG><FONT color="#000099">Выполненная </FONT></STRONG></xsl:if><xsl:if test="document/payment/complete = 'f'"> <STRONG><FONT color="#000099">Ожидаем результат </FONT></STRONG></xsl:if></h4></TD></TR>
	                       <TR><TD><IMG height="80" alt=""  width="80" border="0"  src="xsl/designs.gvidons.net/img/index_00.gif"></IMG></TD><TD></TD><TD></TD><TD></TD><TD></TD><TD></TD></TR> 
			    </tbody>
			</table>
