...
<div>
	...
	<div class="box">
	  <div class="body">
		...
		<A><xsl:attribute name="HREF"><xsl:value-of select="document/to_pay"/></xsl:attribute><IMG border="0" height="20" name="Nindex_14_03" src="xsl/designs.gvidons.net/img/credit-cards.jpg" width="130"></IMG><FONT size="2" color="#002a79"></FONT></A>
	    </div>
	  </div>
	</div>
