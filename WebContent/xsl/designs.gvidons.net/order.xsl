...
и после регистрации вернитесь к сохраненному заказу.
	    ...
	    <div class="description">Ваша корзина<img src="xsl/designs.gvidons.net/img/basket1.gif"/></div>
	    ...
	    <div class="description">Дополнительные расходы<img src="xsl/designs.gvidons.net/img/basket1.gif"/></div>
...
<FORM name="order" action="Order.jsp" >
	    ...
	    <div class="description">Адрес доставки<img src="xsl/designs.gvidons.net/img/basket1.gif"/></div>
