...
<br/>
   ...
   <!-- Кнопки удаления  , конец  -->
	...
	<A><xsl:attribute name="HREF"><xsl:value-of select="document/admin/post_manager"/>
	    ...
	    <h1>Просмотреть поближе дизайн сайта </h1>
...
<table border="0" >
    <tbody>
		...
		<IMG height="400" alt=""  width="400" border="0"><xsl:attribute name="src"><xsl:value-of select="document/product/image"/></xsl:attribute></IMG> 
...
<xsl:if test="document/empty_page_ext1 = 'true'" > 
	...
	<div class="box">
	  <div class="body">
		...
		<A><xsl:attribute name="HREF"><xsl:value-of select="document/shoping_url"/></xsl:attribute><IMG border="0" height="20" name="Nindex_14_03" src="xsl/designs.gvidons.net/img/user.gif" width="20"></IMG>Вернуться на главную страницу </A>
	    </div>
	  </div>
	</div>
<!--
...
-->
	...
	<div class="box">
	  <div class="body">
        ...
        <TABLE height="20" cellSpacing="4" cellPadding="0" width="159" background="index.files/bg11.gif" >
           <TBODY>
            <TR>
                <TD vAlign="center" ><FONT color="white" ><B> Последняя страница</B></FONT>
            </TD>
            </TR>
           </TBODY>
        </TABLE>
	<div class="box">
	  <div class="body">
	    <div class="even" align="left" >
		<A href="#" onClick="javascript:history.back()"  ><IMG border="0"  name="Nindex_14_03" src="xsl/designs.gvidons.net/img/user.gif" height="20"  width="20"></IMG>Назад</A>
...
<!--
	...
	<div class="box">
	  <div class="body">
	    <div class="even" align="left" ><br/><IMG border="0" height="20" name="Nindex_14_03" src="xsl/designs.gvidons.net/img/user.gif" width="20"></IMG> Вы можете перевести денежные средства в магазин для оплаты заказа, используя кредитные карты или виртуальные кошельки, такие как Web money , Яндекс деньги , E-Port и другие  <br/><br/>
...
<xsl:if test="document/empty_page_ext1 = 'false'" > 
	...
	<div class="box">
	  <div class="body">
		...
		<A><xsl:attribute name="HREF"><xsl:value-of select="document/shoping_url"/></xsl:attribute><IMG border="0" height="14" name="Nindex_14_03" src="xsl/designs.gvidons.net/img/user.gif" width="15"></IMG>Продолжить покупки</A>
	    </div>
	  </div>
	</div>
