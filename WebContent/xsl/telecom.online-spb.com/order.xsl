		...
		<table class="blog" cellpadding="0" cellspacing="0">
			...
			<td valign="top">
				<div class="article-bg">
					...
					<tr><td> Address*</td><td><INPUT SIZE="40"  AUTOCOMPLETE="off" TYPE="TEXT" NAME="shipment_address"  id="shipment_address"><xsl:attribute name="value"><xsl:value-of select="document/shipment_address"/></xsl:attribute></INPUT></td></tr>
					<tr><td> Phone* </td><td><INPUT SIZE="40" AUTOCOMPLETE="off" TYPE="TEXT" NAME="shipment_phone"  id="shipment_phone"><xsl:attribute name="value"><xsl:value-of select="document/shipment_phone"/></xsl:attribute></INPUT></td></tr>
					<tr><td> Contact name* </td><td  ><INPUT SIZE="40"  AUTOCOMPLETE="off" TYPE="TEXT" NAME="contact_person"  id="contact_person"><xsl:attribute name="value"><xsl:value-of select="document/contact_person"/></xsl:attribute></INPUT></td>	</tr>
					<tr><td> E-Mail *</td><td><INPUT  title="On this e-mail the account will be sent" SIZE="40" AUTOCOMPLETE="off" id="shipment_email" TYPE="TEXT" NAME="shipment_email"  ><xsl:attribute name="value"><xsl:value-of select="document/shipment_email"/></xsl:attribute></INPUT></td></tr>
					<tr><td> Fax</td><td><INPUT SIZE="40" AUTOCOMPLETE="off" TYPE="TEXT" NAME="shipment_fax"  ><xsl:attribute name="value"><xsl:value-of select="document/shipment_fax"/></xsl:attribute></INPUT></td></tr>
					<tr><td> Comments </td><td><textarea rows="5" NAME="shipment_description"><xsl:value-of select="document/shipment_description"/></textarea></td></tr>
