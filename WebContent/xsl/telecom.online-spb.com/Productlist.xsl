...
<xsl:value-of select="concat('setCurrent(',$page,',',$role, ');')"/>
	...
	<div class="main" style="background-color: #E7E7DF">
				<a><xsl:attribute name="href"><xsl:value-of select="document/host"/></xsl:attribute><IMG alt="Logo"><xsl:attribute name="src"><xsl:value-of select="concat('xsl/',$host,'/images/logo.gif')"/></xsl:attribute></IMG></a>
			</div>
	<div id="gradient">
				...
				<div class="width">
					...
					<div id="right">
			            ...
			            <H3>My Account</H3>
							...
							<div class="cab"><a href="Productlist.jsp?site=2">Who is registered</a></div>
							<div class="cab"><a href="Support.jsp">Support</a></div>
							<div class="cab"><a href="Seo.jsp">Website Promotion</a></div>
							...
							<div class="cab"><a href="Design.jsp">Change design</a></div>
