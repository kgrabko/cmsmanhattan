...
...
	    ...
	    <div class="description"><img src="xsl/holodilnik.gvidons.net/img/basket1.gif"/>Введите номер счета <FORM name="order" action="Order.jsp" ><INPUT SIZE="0"  AUTOCOMPLETE="off" TYPE="TEXT" NAME="account_history_id"></INPUT><INPUT TYPE="submit" name="submit" value="Поиск"></INPUT></FORM></div>
		...
		<div class="box">
		  <div class="body">
			...
			<table >
			    <tbody>
<!--
                       <TR><TD></TD><TD></TD><TD></TD><TD></TD><TD></TD><TD ALIGN="RIGHT"><a><xsl:attribute name="HREF"><xsl:value-of select="document/prev"/></xsl:attribute><IMG height="23" alt="" src="xsl/holodilnik.gvidons.net/2uparrow.jpg" width="25" border="0"></IMG></a></TD></TR>
                       <TR><TD></TD><TD></TD><TD></TD><TD></TD><TD></TD><TD ALIGN="RIGHT" ><a><xsl:attribute name="HREF"><xsl:value-of select="document/next"/></xsl:attribute><IMG height="23" alt="" src="xsl/holodilnik.gvidons.net/2downarrow.jpg" width="25" border="0"></IMG></a></TD></TR> 
