	    ...
	    <h5><strong><%=authorizationPageBeanId.getLocalization(application).getString("help")%></strong></h5>
	      <div class="body">
	        <div class="portletContent odd">
	         <%=authorizationPageBeanId.getLocalization(application).getString("help_exttabs_productpost_1")%>
	        </div>
	        <!-- 
	        <div class="portletContent even">
	         <%= authorizationPageBeanId.getLocalization(application).getString("help_exttabs_productpost_2") %>
	        </div>
	         -->
    	  </div>
	    </div>
		...
		<div class="box">
		  <div class="body">
		    <div >
                     ...
                     <form method="post" name="postsoftform"  ACTION="ExtTabsProductPost.jsp" onSubmit="return  IsFormOk()"  >
					...
					<font color='white' size='2' > &nbsp;&raquo; <%=authorizationPageBeanId.getLocalization(application).getString("title_form_post_full_info")%>  </font>
                     ...
                     <input type="hidden"  name="portlettype_id"  value="4"/>
