...
%>
<% // Old page So use RecommentedItemPost.jsp  %>
<html>
<head>
...
<table class="columns">
    ...
    <tbody>
		...
		<%=catalogListBeanId.getCatalogUrlPath("Co1ProductPost.jsp",authorizationPageBeanId)%>
		</div>
		</div>
		</div>
       ...
       <!--  list catalog  -->
		<div class="box">
		  <div class="body">
		    <div >
	         <%=publisherBeanId.getAction().equals("")?catalogListBeanId.getNavigator("Co1ProductPost.jsp",authorizationPageBeanId):""%>
     	     <%=publisherBeanId.getAction().equals("add")?catalogAddBeanId.getAddFormWithJsp("Co1ProductPost.jsp"):""%>
	         <%=publisherBeanId.getAction().equals("edit")?catalogEditBeanId.getEditForm(catalogListBeanId.rows[catalogEditBeanId.getIndx_select()][0] , catalogListBeanId.rows[catalogEditBeanId.getIndx_select()][1],"Co1ProductPost.jsp"):""%>
      ...
      <form method="post" name="postsoftform"  ACTION="Co1ProductPost.jsp" onSubmit="return  IsFormOk()"  >
	<!-- 
      <br/>
		<br/>
		 <div class="box">
		  ...
		  <div class="body">
		    <div >
					...
					-->
                     ...
                     <input type="hidden"  name="portlettype_id"  value="1"/>
