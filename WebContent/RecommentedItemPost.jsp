...
<table class="columns">
    ...
    <tbody>
		...
		<%=catalogListBeanId.getCatalogUrlPath("RecommentedItemPost.jsp",authorizationPageBeanId)%>
		</div>
		</div>
		</div>
       ...
       <!--  list catalog  -->
		<div class="box">
		  <div class="body">
		    <div >
	         <%=publisherBeanId.getAction().equals("")?catalogListBeanId.getNavigator("RecommentedItemPost.jsp",authorizationPageBeanId):""%>
     	     <%=publisherBeanId.getAction().equals("add")?catalogAddBeanId.getAddFormWithJsp("RecommentedItemPost.jsp"):""%>
	         <%=publisherBeanId.getAction().equals("edit")?catalogEditBeanId.getEditForm(catalogListBeanId.rows[catalogEditBeanId.getIndx_select()][0] , catalogListBeanId.rows[catalogEditBeanId.getIndx_select()][1],"RecommentedItemPost.jsp"):""%>
      ...
      <form method="post" name="postsoftform"  ACTION="RecommentedItemPost.jsp" onSubmit="return  IsFormOk()"  >
	<!-- 
      <br/>
		<br/>
		 <div class="box">
