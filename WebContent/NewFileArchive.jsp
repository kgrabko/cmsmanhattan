...
//-->
  ...
  <BODY>
  <h5><%=authorizationPageBeanId.getLocalization(application).getString("upload_file_archive_from_user")%></h5>
  <br/><%=authorizationPageBeanId.getLocalization(application).getString("upload_file_archive_from_user_description")%> <br/>
