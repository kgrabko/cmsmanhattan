...
response.setDateHeader ("Expires", 0); //prevents caching at the proxy server // It is wrong page so use ProductInfoColumnOneUserPost.jsp
request.setCharacterEncoding("UTF-8");
%>
<% // Old page So use ProductInfoColumnOneUserPost.jsp  %>
<html>
<head>
...
if(isEmpty( document.postsoftform.bigimagename.value)){ alert('Field image did not fill'); return false; }
...
<table class="columns">
	...
	<div>
	    ...
	    <h5><strong><%=authorizationPageBeanId.getLocalization(application).getString("help")%></strong></h5>
	      <div class="body">
	        <div class="portletContent odd">
	         <%=authorizationPageBeanId.getLocalization(application).getString("help_ext1_productpost_1")%>
	        </div>
	        <!-- 
	        <div class="portletContent even">
	         <%= authorizationPageBeanId.getLocalization(application).getString("help_ext1_productpost_2") %>
	        </div>
	        -->
    	  </div>
	    </div>
		...
		<div class="box">
		  <div class="body">
		    <div >
                     <form method="post" name="postsoftform"  ACTION="Ext1ProductPostUser.jsp" onSubmit="return  IsFormOk()"  >
