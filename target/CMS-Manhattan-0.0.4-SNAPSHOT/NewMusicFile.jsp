...
<HTML>
  <HEAD>
    <TITLE><%=AuthorizationPageBeanId.getLocalization(application).getString("upload_music_from_user")%> </TITLE>
  ...
  <BODY>
  <h5><%=AuthorizationPageBeanId.getLocalization(application).getString("upload_music_from_user")%> </h5>
  <br/> <%=AuthorizationPageBeanId.getLocalization(application).getString("upload_music_from_user_description")%> 
  <br/>
