...
public class CheckPaymentResult implements java.io.Serializable  { 
	...
	public String CheckOrder(OrderBank objOrderBank) {
		...
		try {
			...
			bufferedreader = postData(
					"http://pgate.grabko.com:88/authorizationResults.do",
					request);
			String nextLine = "";
	...
	public void parserRequest(String i_strNumerOrder, String i_strRezult,
			String i_strDecsription) {
	...
	void end_addmoney(QueryManager Adp, String i_strAccountHistory_id,
		...
		try {
			...
			//query = "UPDATE account_hist SET complete = true  , active = false , rezult_cd = '"+ i_strRezult + "'  WHERE  id = " + i_strAccountHistory_id;
