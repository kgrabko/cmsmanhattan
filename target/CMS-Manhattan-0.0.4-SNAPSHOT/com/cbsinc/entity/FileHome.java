 ...
 * @see com.cbsinc.entity.File
 * @author Hibernate Tools
 */
public class FileHome {

	private static final Log log = LogFactory.getLog(FileHome.class);
	...
	public File merge(File detachedInstance) {
		...
		try {
			File result = (File) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public File findById(long id) {
		...
		try {
			File instance = (File) sessionFactory.getCurrentSession().get(
					"com.cbsinc.entity.File", id);
			if (instance == null) {
	...
	public List findByExample(File instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.cbsinc.entity.File")
