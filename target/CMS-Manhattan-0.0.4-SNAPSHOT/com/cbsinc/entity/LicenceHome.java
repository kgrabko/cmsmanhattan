...
/**
 * Home object for domain model class Licence.
 * @see com.cbsinc.entity.Licence
 * @author Hibernate Tools
 */
public class LicenceHome {

	private static final Log log = LogFactory.getLog(LicenceHome.class);
	...
	public void persist(Licence transientInstance) {
		log.debug("persisting Licence instance");
		try {
	...
	public Licence merge(Licence detachedInstance) {
		...
		try {
			Licence result = (Licence) sessionFactory.getCurrentSession()
	...
	public Licence findById(long id) {
		...
		try {
			Licence instance = (Licence) sessionFactory.getCurrentSession()
					.get("com.cbsinc.entity.Licence", id);
			if (instance == null) {
	...
	public List findByExample(Licence instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.cbsinc.entity.Licence")
