...
function isAddressValid(){
	...
	if(object != null){
		if (object.value.length == 0){
			message = message + "\u0423\u043a\u0430\u0436\u0438\u0442\u0435 \u0441\u0442\u0440\u0430\u043d\u0443.\n";
		}
	}
	...
	if(object != null){
		if (object.value.length == 0){
			message = message + "\u0423\u043a\u0430\u0436\u0438\u0442\u0435 \u0430\u0434\u0440\u0435\u0441 \u0434\u043e\u0441\u0442\u0430\u0432\u043a\u0438.\n";
		}
	}
	...
	if(object != null){
		if (object.value.length == 0){
			message = message + "\u0423\u043a\u0430\u0436\u0438\u0442\u0435 \u043a\u043e\u043d\u0442\u0430\u043a\u0442\u043d\u044b\u0439 \u0442\u0435\u043b\u0435\u0444\u043e\u043d.\n";
		}
	}
	...
	if(object != null){
		if (object.value.length == 0){
			message = message + "\u0423\u043a\u0430\u0436\u0438\u0442\u0435 \u043a\u043e\u043d\u0442\u0430\u043a\u0442\u043d\u043e\u0435 \u043b\u0438\u0446\u043e.\n";
		}
	}
	...
	if(object != null){
		if (object.value.length == 0){
			message = message + "\u0423\u043a\u0430\u0436\u0438\u0442\u0435 \u0430\u0434\u0440\u0435\u0441 \u044d\u043b\u0435\u043a\u0442\u0440\u043e\u043d\u043d\u043e\u0439 \u043f\u043e\u0447\u0442\u044b.\n";
		}
	}	
