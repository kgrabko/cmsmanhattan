...
...
	    ...
	    <div class="description"><img src="xsl/plita.gvidons.net/img/basket1.gif"/>Введите номер заказа <FORM name="order" action="Order.jsp" ><INPUT SIZE="0"  AUTOCOMPLETE="off" TYPE="TEXT" NAME="order_id"><xsl:attribute name="value"><xsl:value-of select="document/list/order/order_id"/></xsl:attribute></INPUT><INPUT TYPE="submit" name="submit" value="Найти"></INPUT></FORM></div>
