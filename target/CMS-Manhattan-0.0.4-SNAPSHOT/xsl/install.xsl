...
<form method="post" ACTION="Install.jsp"  >
	   <h1> <font size="3" > <b> Установка интернет магазина </b> </font>  - <font size="2" > <xsl:value-of select="document/message"/></font> </h1>
<br/>
<center>
...
<TR><TD>Адрес :  </TD> <TD><input size="40"  AUTOCOMPLETE="off" TYPE="TEXT"  name="Address" value=""  ><xsl:attribute name="value"><xsl:value-of select="document/icq"/></xsl:attribute></input></TD></TR>
<TR><TD>Домен (имя сайта)  :  </TD> <TD><input size="40"  AUTOCOMPLETE="off" TYPE="TEXT"  name="Website" value="" ><xsl:attribute name="value"><xsl:value-of select="document/website"/></xsl:attribute></input></TD></TR>
...
<table>
    <tbody>
	<TR><TD width="180"  ></TD>  <TD><input type="submit" name="Submit" value="Установить"></input></TD><TD></TD> <TD><input type="reset" value="Сброс"></input></TD><TD></TD> </TR>
    </tbody>
</table>
