...
<!--      <img src="xsl/english.gvidons.net/img/logotip.gif" border="0" height="70" width="90"   /> -->
    ...
    <TD vAlign="center" Align="right"  width="80%">
		...
		<br />
		    ...
		    <input id="search_char"  name="search_char" type="hidden"  size="20" ></input>
        ...
        <div class="tabs">
           ...
           <a href="ProductlistCre.jsp?catalog_id=-2"  class="selected"> <font size="2"> Поиск по критериям </font></a>
          <!-- <a href="pogoda.html" class="plain"> <font size="2">О погоде </font></a> -->
           <a href="irc/irc1.html" class="plain"> <font size="2">Чат Антхил</font></a>
            ...
            <span>
              <CENTER>
                <font size="2"  color="red"  >
                 Поиск по критериям пока не работает 
	        </font>
	       </CENTER>
            </span>
        </div>
          ...
          <div class="body">
            ...
            <div class="content even"> 
                <a href="Authorization.jsp?Login=newuser">
                   <img src="xsl/english.gvidons.net/img/linkTransparent.gif" alt="Link icon" title="Link icon" height="11" width="6" border="0" />
    ...
    <form name="searchcreform"  action="Productlist.jsp" >	  
 	    ...
 	    <table width="120"  ><tr>
             <td width="50"  > Формат: </td>
              <td align="right" > <SELECT NAME = "creteria5_id"  >
		...
		<input class="context searchButton"  type="button" size="20" value="Искать"  tabindex="30002" onClick="return top.search_word();return true"   />
		</TD>
              </TR>
...
<!-- Reklamma -->
        <div class="tabs">
           ...
           <!-- <a href="/grabko/" class="selected" ><font size="2"> платежный шлюз </font> </a> -->
