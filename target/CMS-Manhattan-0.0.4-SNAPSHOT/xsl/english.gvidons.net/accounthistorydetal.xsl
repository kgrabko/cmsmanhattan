		...
		<div class="box">
		  <div class="body">
			...
			<table >
				...
				<xsl:if test="document/payment/complete = 't'"> <STRONG><FONT color="#000099">Executed </FONT></STRONG></xsl:if><xsl:if test="document/payment/complete = 'f'"> <STRONG><FONT color="#000099">Ожидаем результат </FONT></STRONG></xsl:if>
				</xsl:if>
				</h4></TD></TR>
