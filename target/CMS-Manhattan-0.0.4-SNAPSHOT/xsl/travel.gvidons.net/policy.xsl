...
<TD vAlign="top" Align="center" width="1050">
...
<table border="0" >
    <tbody>
		...
		<IMG height="240" alt=""  width="600" border="0"><xsl:attribute name="src"><xsl:value-of select="document/product/image"/></xsl:attribute></IMG> 
...
<xsl:if test="document/empty_page_ext1 = 'true'" > 
	...
	<div class="box">
	  <div class="body">
		...
		<A><xsl:attribute name="HREF"><xsl:value-of select="document/shoping_url"/></xsl:attribute><IMG border="0" height="20" name="Nindex_14_03" src="xsl/www.gvidons.com/img/user.gif" width="20"></IMG>Вернуться на главную страницу </A>
	    </div>
	  </div>
	</div>
<!--
...
-->
	...
	<div class="box">
	  <div class="body">
	    <div class="even" align="left" >
		<A href="#" onClick="javascript:history.back()"  ><IMG border="0"  name="Nindex_14_03" src="xsl/www.gvidons.com/img/user.gif" height="20"  width="20"></IMG>Назад</A>
