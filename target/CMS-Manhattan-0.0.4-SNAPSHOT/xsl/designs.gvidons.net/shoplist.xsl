...
<table class="columns">
    ...
    <div class="box">
        <div class="body" >
            ...
            <div class="even"> 
                <a href="">
                   <img src="xsl/designs.gvidons.net/img/user.gif" alt="Link icon" title="Link icon" height="20" width="20" border="0" />
...
<div>
	...
	<div class="box">
	  <div class="body">
		...
		<IMG border="0" height="20" name="Nindex_14_03" src="xsl/designs.gvidons.net/img/user.gif" width="20"/>
...
onmouseout="&#13;&#10;&#9;&#9;&#9;&#9;&#9;&#9;&#9;&#9;style.backgroundColor='#EFEFEF'"
  hight="60" align="left" bgColor="#EFEFEF"  >
			                 <A><xsl:attribute name="HREF"><xsl:value-of select="url"/></xsl:attribute><IMG border="0" height="14" name="Nindex_14_03" src="xsl/designs.gvidons.net/dir.gif" width="15"></IMG><STRONG><FONT size="2" color="#103d43">.<xsl:value-of select="item"/></FONT></STRONG></A> 
				            </TD></TR>   	          		
				    </xsl:for-each>
