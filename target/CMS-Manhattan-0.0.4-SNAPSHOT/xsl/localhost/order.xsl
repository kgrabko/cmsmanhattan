...
<!--
        <div class="even">
	<strong>1.</strong>  Файлы Вы можете скачать только приналичии денежных средств на счету. Если у Вас на счету не хватает денежных средств, то нужно пополнить счет. Для этого Вы можете воспользоваться кредитными картами или электронными кошельками.
        </div>                                                                                 

        <div class="even">
	<strong>2.</strong> При недостаточном балансе Вы можете скачать только демоверсию.
        </div>
-->
        <div class="even">
	<strong>1.</strong> Каждый, кто зарегистрировался у нас на сайте получает почтовый ящик. 
        </div>

        <div class="even">
	<strong>2.</strong>   Фильмы можно скачать только отключив Download manager ( менеджер закачек фаилов ).
        </div>

        <div class="even">
	<strong>3.</strong>   Повторное скачивание фаила невозможно. Требуется снова добавить этот файл в корзину.
        </div>

        <div class="even">
	<strong>3.</strong>   Интернет магазин работает в режиме тестирования, поэтому все файлы скачиваются бесплатно.
        </div>
	    ...
	    <div class="description">Ваша корзина<img src="xsl/www.gvidons.com/img/basket1.gif"/></div>
	    ...
	    <div class="description">Дополнительные расходы<img src="xsl/www.gvidons.com/img/basket1.gif"/></div>
...
<FORM name="order" action="Order.jsp" >
	    ...
	    <div class="description">Адрес доставки<img src="xsl/www.gvidons.com/img/basket1.gif"/></div>
