...
<xsl:if test="document/empty_page_ext1 = 'true'" > 
	...
	<div class="box">
	  <div class="body">
		...
		<A><xsl:attribute name="HREF"><xsl:value-of select="document/shoping_url"/></xsl:attribute><IMG border="0" height="20" name="Nindex_14_03" src="xsl/vityazka.gvidons.net/img/user.gif" width="20"></IMG>Вернуться на главную страницу </A>
	    </div>
	  </div>
	</div>
<!--
...
<xsl:if test="document/empty_page_ext1 = 'false'" > 
	...
	<div class="box">
	  <div class="body">
		...
		<A><xsl:attribute name="HREF"><xsl:value-of select="document/shoping_url"/></xsl:attribute><IMG border="0" height="14" name="Nindex_14_03" src="xsl/vityazka.gvidons.net/img/user.gif" width="15"></IMG>Продолжить покупки</A>
	    </div>
	  </div>
	</div>
