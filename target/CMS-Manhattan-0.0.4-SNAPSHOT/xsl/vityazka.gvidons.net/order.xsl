...
<!--      <img src="xsl/vityazka.gvidons.net/img/logotip.gif" border="0" height="70" width="90"   /> -->
    ...
    <TD vAlign="center" Align="right"  width="80%">
        ...
        <div class="pathBar">
            <span>
             <!--   <span> <xsl:value-of select="document/contact_person"/>  </span> -->
               <CENTER>  <span> <font size="2" color="red"  >  ВНИМАНИЕ  !!! У КОГО ЕСТЬ ИНТЕРЕСНЫЕ ФИЛЬМЫ !!! ПИШИТЕ МНЕ НА АДРЕС grabko@mail.ru. Я ИХ ВЫЛОЖУ ДЛЯ ВСЕХ. </font> </span></CENTER>
            </span>
...
и после регистрации вернитесь к сохраненному заказу.
	    ...
	    <div class="description">Ваша корзина<img src="xsl/vityazka.gvidons.net/img/basket1.gif"/></div>
	    ...
	    <div class="description">Дополнительные расходы<img src="xsl/vityazka.gvidons.net/img/basket1.gif"/></div>
...
<FORM name="order" action="Order.jsp" >
	    ...
	    <div class="description">Адрес доставки<img src="xsl/vityazka.gvidons.net/img/basket1.gif"/></div>
