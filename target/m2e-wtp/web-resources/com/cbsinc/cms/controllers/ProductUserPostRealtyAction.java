...
public class ProductUserPostRealtyAction implements IAction 
{
		...
		action( request,  response,  servletContext) ;
			...
			if ( request.getParameter("gen_number") != null )
			{
				...
				if(!val1.equals(gen_code.trim())) 
				{
					...
					response.sendRedirect("ProductUserPostRealty.jsp" );
				}
			}
			else
			{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response, ServletContext servletContext) throws Exception 
	{
		...
		SoftPostBeanId.setCriteria1_label(productPostAllFaced.getOneLabel("select  label   from creteria1   where  active = true " + SoftPostBeanId.getPartCriteria(AuthorizationPageBeanId.getSite_id(), is_criteria_by_catalog) ));
		SoftPostBeanId.setCriteria2_label(productPostAllFaced.getOneLabel("select  label   from creteria2   where  active = true " + SoftPostBeanId.getPartCriteria(AuthorizationPageBeanId.getSite_id(), is_criteria_by_catalog) ));
		SoftPostBeanId.setCriteria3_label(productPostAllFaced.getOneLabel("select  label   from creteria3   where  active = true " + SoftPostBeanId.getPartCriteria(AuthorizationPageBeanId.getSite_id(), is_criteria_by_catalog) ));
		SoftPostBeanId.setCriteria4_label(productPostAllFaced.getOneLabel("select  label   from creteria4   where  active = true " + SoftPostBeanId.getPartCriteria(AuthorizationPageBeanId.getSite_id(), is_criteria_by_catalog) ));
		SoftPostBeanId.setCriteria5_label(productPostAllFaced.getOneLabel("select  label   from creteria5   where  active = true " + SoftPostBeanId.getPartCriteria(AuthorizationPageBeanId.getSite_id(), is_criteria_by_catalog) ));
		SoftPostBeanId.setCriteria6_label(productPostAllFaced.getOneLabel("select  label   from creteria6   where  active = true " + SoftPostBeanId.getPartCriteria(AuthorizationPageBeanId.getSite_id(), is_criteria_by_catalog) ));
		SoftPostBeanId.setCriteria7_label(productPostAllFaced.getOneLabel("select  label   from creteria7   where  active = true " + SoftPostBeanId.getPartCriteria(AuthorizationPageBeanId.getSite_id(), is_criteria_by_catalog) ));
		SoftPostBeanId.setCriteria8_label(productPostAllFaced.getOneLabel("select  label   from creteria8   where  active = true " + SoftPostBeanId.getPartCriteria(AuthorizationPageBeanId.getSite_id(), is_criteria_by_catalog) ));
		SoftPostBeanId.setCriteria9_label(productPostAllFaced.getOneLabel("select  label   from creteria9   where  active = true " + SoftPostBeanId.getPartCriteria(AuthorizationPageBeanId.getSite_id(), is_criteria_by_catalog) ));
		SoftPostBeanId.setCriteria10_label(productPostAllFaced.getOneLabel("select  label   from creteria10   where  active = true " + SoftPostBeanId.getPartCriteria(AuthorizationPageBeanId.getSite_id(), is_criteria_by_catalog) ));
		

		
		SoftPostBeanId.setSelect_creteria1_id(productPostAllFaced.getComboBoxAutoSubmitLocale("creteria1_id",SoftPostBeanId.getCreteria1_id(), notselected ,  "select creteria1_id , name   from creteria1   where  active = true " + SoftPostBeanId.getPartCriteria(AuthorizationPageBeanId.getSite_id(), is_criteria_by_catalog) )) ;
...
//		else
//		{
//////		--catalog_listBean.setParent_id(productlistBeanId.getCatalog_parent_id());
//		  AuthorizationPageBeanId.setCatalog_id(AuthorizationPageBeanId.getCatalog_id());
//		}
