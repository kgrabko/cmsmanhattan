...
public class CreateShopBean implements java.io.Serializable { 
	...
	public void cretareSiteDirWithExtract(String zipfilename , String zipfilepath, String newSiteDir , ServletContext applicationContext) {
		try {
			...
			//copyDir(path + "//xsl//" + defaultSite + "//img", path + "//xsl//"+ newSiteDir + "//img");
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		;
	...
	public void unzipFile (String zipfilename , String zipfilepath ,String workdirpath , ServletContext applicationContext ) {
		...
		try
		{
			...
			{
				message = "Р¤Р°РёР» " + zipfilename + "РЅРµ РїСЂР°РІРµР»СЊРЅРѕРіРѕ С‚РёРїР°. Р¤Р°РёР» РґРѕР»Р¶РµРЅ Р±С‹С‚СЊ СѓРїРѕРєРѕРІР°РЅ РІ zip Р°СЂС…РёРІ." ;
				log.info(message);
				return ;
			}
	        ...
	        ZipEntry entry;
	         ...
	         while((entry = zis.getNextEntry()) != null) 
	         {
	            ...
	            //String filename = entry.getName().substring(entry.getName().indexOf((char)47)+1) ;
	            String filename = entry.getName() ;
	            if(filename.equals("")  || filename.endsWith("/")) continue ;
	         ...
	         {
	        	 ITransformationService iTransformationService = (ITransformationService) applicationContext.getAttribute("ITransformationService") ;
	...
	void createDirForFile(File file)
	{
		...
		{
			if(childfile.getParentFile().isFile()) continue ; 
...
//	}
	...
	public void addShopWithExtract_ru_addcontent( AuthorizationPageBean AuthorizationPageBeanId , String product_id , ServletContext applicationContext ) {
		...
		try {
			...
			//site_id , owner , host , home_dir , site_dir , person , phone  , address , active
...
//			dbAdaptor.executeInsertWithArgs(query, args);
		...
		dbAdaptor.executeInsertWithArgs(query, args);
		//UPDATE CRETERIA1 set CRETERIA1_ID =  CRETERIA1_ID  * -1  WHERE  NAME = 'РќРµ РІС‹Р±СЂР°РЅРѕ'
		//UPDATE CRETERIA2 set CRETERIA2_ID =  CRETERIA2_ID  * - 1  WHERE  NAME = 'РќРµ РІС‹Р±СЂР°РЅРѕ'
		//UPDATE CRETERIA3 set CRETERIA3_ID =  CRETERIA3_ID  * - 1  WHERE  NAME = 'РќРµ РІС‹Р±СЂР°РЅРѕ'
		...
		dbAdaptor.executeInsertWithArgs(query, args);
			...
			args.put("description","<r>РџРѕРёСЃРєРѕРІС‹Рµ РІРѕР·Р�?РѕР¶РЅРѕСЃС‚Рё РёРЅС‚РµСЂРЅРµС‚-Р�?Р°РіР°Р·РёРЅР°</r>");
			args.put("fulldescription","<r>1. Р”Р»СЏ РїРѕР»РЅРѕС†РµРЅРЅРѕР№ СЂР°Р±РѕС‚С‹ CMS Business One, РІР°Р�? РЅСѓР¶РЅРѕ РЅР°СЃС‚СЂРѕРёС‚СЊ СЂР°СЃС€РёСЂРµРЅРЅС‹Р№ РїРѕРёСЃРє РїРѕ РєСЂРёС‚РµСЂРёСЏР�?</r>"
					...
					+ "<r>Р”Р°Р»РµРµ РїРµСЂРµС…РѕРґРёР�? Рє РїСѓРЅРєС‚Сѓ 2 Рё С‚.Рґ.</r>"
					+ "<r></r>"
...
/*
			...
			args.put("description","<r> Р”Р»СЏ РїРѕР»РЅРѕС†РµРЅРЅРѕР№ СЂР°Р±РѕС‚С‹ РІР°С€РµРіРѕ Р�?Р°РіР°Р·РёРЅР° РЅР° РѕСЃРЅРѕРІРµ CMS Business One  </r>");
...
*/			
			...
			args.put("fulldescription","<r>"
					+ " РњС‹ РІСЃС‚СЂРѕРёР»Рё С„РѕСЂСѓР�? РІ РЅР°С€Сѓ CMS Business One.  </r>"
					+ "<r>"
			...
			args.put("fulldescription",""
					+ "<r> Р’Р°С€ РёРЅС‚РµСЂРЅРµС‚-Р�?Р°РіР°Р·РёРЅ РЅР°С…РѕРґРёС‚СЃСЏ РїРѕ Р°РґСЂРµСЃСѓ http://www.siteforyou.com/Productlist.jsp?site=" + site_id + "  </r>"
					+ "<r> Р’Р°С€ РїРѕС‡С‚РѕРІС‹Р№ СЏС‰РёРє "+ AuthorizationPageBeanId.getStrLogin()+"@bossmail.me </r>"
	...
	//+++		
			...
			args.put("description","<r>Р’ РёРЅС„РѕСЂР�?Р°С†РёРѕРЅРЅРѕР�? Р�?РѕРґСѓР»Рµ Р�?РѕР¶РЅРѕ СЂР°Р·Р�?РµС‰Р°С‚СЊ С‚РµРєСЃС‚, РёР·РѕР±СЂР°Р¶РµРЅРёСЏ РЅР° С„РѕСЂР�?Р°С… СЃ РєСЂР°С‚РєРёР�? Рё РїРѕРґСЂРѕР±РЅС‹Р�? РѕРїРёСЃР°РЅРёРµР�?, РїСЂРёРєСЂРµРїР»СЏС‚СЊ С„Р°Р№Р»С‹, СѓСЃС‚Р°РЅР°РІР»РёРІР°С‚СЊ С†РµРЅСѓ, Р° С‚Р°РєР¶Рµ РІРєР»СЋС‡Р°С‚СЊ РіРѕР»РѕСЃРѕРІР°РЅРёРµ РёР»Рё С„РѕСЂСѓР�? РґР»СЏ РєР°Р¶РґРѕРіРѕ РєРѕРЅРєСЂРµС‚РЅРѕРіРѕ РёРЅС„РѕСЂР�?Р°С†РёРѕРЅРЅРѕРіРѕ Р�?РѕРґСѓР»СЏ. </r>");
...
query = sequences_rs.getString("soft");
			...
			args.put("description","<r> РљР°Рє РёР·Р�?РµРЅРёС‚СЊ РєСЂРёС‚РµСЂРёРё РґР»СЏ РїРѕРёСЃРєР° Р�?РѕРµРіРѕ РёРЅС„РѕР�?Р°С†РёРѕРЅРЅРѕРіРѕ Р�?РѕРґСѓР»СЏ </r>");
			args.put("fulldescription","<r>"
...
*/
			...
			args.put("description","<r> Р”РѕР±Р°РІР»РµРЅРёРµ, СЂРµРґР°РєС‚РёСЂРѕРЅРёРµ, СѓРґР°Р»РµРЅРёРµ СЂР°Р·РґРµР»РѕРІ</r>");
			args.put("fulldescription","<r></r>"
					+ "<r>  </r>"
					+ "<r>  </r>"
					+ "<r>  </r>"
			...
			*/
			...
			args.put("description","<r> РњР°РіР°Р·РёРЅ РїРѕРґРґРµСЂР¶РёРІР°РµС‚ РїРѕРёСЃРєР° РїРѕ Р·Р°РіРѕР»РѕРІРєСѓ РїРѕР»СѓР»СЏ </r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
			...
			args.put("description","<r> РњР°РіР°Р·РёРЅ РїРѕРґРґРµСЂР¶РёРІР°РµС‚  СЃРёСЃС‚РµР�?Сѓ РѕР±СЃСѓР¶РґРµРЅРёСЏ РёРЅС„РѕСЂР�?Р°С†РёРѕРЅРЅРѕРіРѕ Р�?РѕРґСѓР»СЏ </r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
			...
			args.put("description","<r> Р’С‹ Р�?РѕР¶РµС‚Рµ СѓС‚Р°РЅРѕРІРёС‚СЊ РґРѕ 21 РєР°СЂС‚РёРЅРєРё РґР»СЏ РѕРґРЅРѕРіРѕ РёРЅС„РѕСЂР�?Р°С†РёРѕРЅРЅРѕРіРѕ Р�?РѕРґСѓР»СЏ РєР°Рє  РѕРїРёСЃР°РЅРёСЏ С‚РѕРІР°СЂР° РёР»Рё РЅРѕРІРѕСЃС‚Рё </r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
			...
			args.put("site_id", Long.valueOf(site_id) );
			args.put("active", true );
			args.put("portlettype_id", Layout.PORTLET_TYPE_CENTER  );
			...
			*/
			...
			args = new HashMap();
			args.put("soft_id",Long.valueOf(soft_id) );
			args.put("name", " РџСЂРёРєСЂРµРїР»РµРЅРёРµ С„Р°Р№Р»РѕРІ Рє РёРЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р�? Рё РЅРѕРІРѕСЃС‚РЅС‹Р�? Р�?РѕРґСѓР»СЏР�? "  );
			args.put("description","<r> РџСЂРёРєСЂРµРїР»РµРЅРёРµ С„Р°Р№Р»РѕРІ Рє РёРЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р�? Рё РЅРѕРІРѕСЃС‚РЅС‹Р�? Р�?РѕРґСѓР»СЏР�?</r>");
			args.put("fulldescription","<r></r>"
					+ "<r> </r>"
					+ "<r> </r>"
					+ "<r> </r>"
			...
			*/
			...
			args.put("description","<r> Р’С‹ Р�?РѕР¶РµС‚Рµ РІРµСЃС‚Рё РґРёСЃРєСѓСЃРёРё РїРѕ С‚РѕРІР°СЂСѓ РёР»Рё РЅРѕРІРѕСЃС‚СЏР�? Рё РїСЂР°Р№СЃ Р»РёСЃС‚Сѓ.</r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
			...
			args.put("soft_id",Long.valueOf(soft_id) );
			args.put("name", " Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ  "  );
			args.put("description","<r> РЎРїР°СЃРёР±Рѕ РѕС‚ Center Business Solutions ltd.  С‡С‚Рѕ РІРѕСЃРїРѕР»СЊР·РѕРІР°Р»РёСЃСЊ РЅР°С€РµР№ CMS .</r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
...
//			Create About Page
			...
			args.put("fulldescription","<r>"
					+ " РќР°Р·РІР°РЅРёРµ РєРѕР�?РїР°РЅРёРё: " + AuthorizationPageBeanId.getStrCompany()
					+ "</r>"
...
//			Create About Page
			...
			args.put("fulldescription","<r>"
					+ " РћРїР»Р°С‚Р° Р·Р°РєР°Р·Р° " + AuthorizationPageBeanId.getCompany_name()
					+ "</r>"
...
//cretareSiteDirWithExtract(file_name, file_path, site_dir,applicationContext);
	...
	public void addShopWithExtract_allLang( AuthorizationPageBean AuthorizationPageBeanId , String product_id , ServletContext applicationContext ) {
	...
	public void addShopWithExtract( AuthorizationPageBean AuthorizationPageBeanId , String product_id , ServletContext applicationContext ) {
...
//			Create About Page
	...
	public void addShopWithExtract_en( AuthorizationPageBean AuthorizationPageBeanId , String product_id , ServletContext applicationContext) {
		String file_name = "" ;
		String file_path = "" ;
		String query = "";
		long intOwnerUserId  = 0 ;
...
/**		
	...
	*/	
		...
		//UPDATE CRETERIA1 set CRETERIA1_ID =  CRETERIA1_ID  * -1  WHERE  NAME = 'Not chosen'
		//UPDATE CRETERIA2 set CRETERIA2_ID =  CRETERIA2_ID  * - 1  WHERE  NAME = 'Not chosen'
		//UPDATE CRETERIA3 set CRETERIA3_ID =  CRETERIA3_ID  * - 1  WHERE  NAME = 'Not chosen'
		//delete  * FROM creteria2 where CRETERIA2_id < 0
		String creteria_id = "" ;
		query = "SELECT MIN(CRETERIA1_ID) - 1  as ID FROM creteria1" ;
		dbAdaptor.executeQuery(query);
		...
		dbAdaptor.executeInsertWithArgs(query, args);
			...
			args.put ("fulldescription", "<r> 1. For high-grade work CMS Business One, you need to adjust the expanded search in criteria </r>"
					...
					+ "<r> </r>"
					+ "<r> Other independent criteria it is got similarly. Look items 1-5 </r>"
					+ "<r> </r>"
					+ "<r> the Step-by-step description of input of dependent criterion: </r>"
					...
					+ "<r> Further we pass to item 2 etc. </r>"
					+ "<r> </r>"
			...
			args.put ("fulldescription", "<r>"
					+ "We have established the news module in Internet shop </r>"
					...
					+ "<r> your news does not remain not noticed where there would be no your client. </r>"
					+ "<r> </r>"
					...
					+ "<r> 16. Enter from a picture a code. </r>"
					+ "<r> 17. Press the button to SAVE. </r>");
			args.put("catalog_id",SpecialCatalog.OUTPUT_PAGES_FROM_NEWS_CATALOG );
			args.put("site_id", Long.valueOf(site_id) );
			args.put("lang_id",AuthorizationPageBeanId.getLang_id());
			args.put("active", true );
			...
			args.put ("fulldescription", ""
					+ "<r> your Internet shop is accessible  by link http://www.siteforyou.com/Productlist.jsp?site=" + site_id + "</r>"
					+ "<r> also you can buy domain here </r>"
			...
			args.put ("description", "<r> In the information module  you can  place  the text, to place  images on forms with short and detailed description  and attach files, to set a price, and also to include voting or a forum for each concrete information module. </r>");
			args.put ("fulldescription", "<r> </r>"
...
*/
			...
			*/
			...
			args.put("fulldescription","<r>"
					+ "  The information module for main page 1."
					+ "</r>"
...
//			Create About Page
			...
			args.put("fulldescription","<r>"
					+ " Name of company: " + AuthorizationPageBeanId.getStrCompany()
					+ "</r>"
					+ "<r> Phone"+ AuthorizationPageBeanId.getStrPhone() +" </r>"
					+ "<r> Fax: "+ AuthorizationPageBeanId.getStrFax() +" </r>"
					+ "<r> EMail: "+ AuthorizationPageBeanId.getStrEMail() +" </r>" );
...
//			Create About Page
			...
			args.put("fulldescription","<r>"
					+ " Delivery from " + AuthorizationPageBeanId.getCompany_name()
					+ "</r>"
					...
					+ "<r> Account Web Money: 1111222333444 </r>"
					+ "<r> Account Yandex Money: 333442234455 </r>"
...
//			Create About Page
			...
			args.put("fulldescription","<r>"
					+ " Order payment " + AuthorizationPageBeanId.getCompany_name()
					+ "</r>"
					+ "<r> Payment perform by way  translation of money resources on the company score through payment systems or through bank by direct payment </r>"
					+ "<r> Account Web Money: 1111222333444 </r>"
					+ "<r> Account Yandex Money: 333442234455 </r>"
...
//			Create About Page
			...
			args.put("fulldescription","<r>"
					+ " Contacts us " + AuthorizationPageBeanId.getCompany_name()
					+ "</r>"
					+ "<r> Payment perform by way  translation of money resources on the company score through payment systems or through bank by direct payment </r>"
					+ "<r> Account Web Money: 1111222333444 </r>"
					+ "<r> Account Yandex Money: 333442234455 </r>"
...
//			Create About Page
			...
			args.put("fulldescription","<r>"
					+ " Careers with " + AuthorizationPageBeanId.getCompany_name()
					+ "</r>"
					+ "<r> Payment perform by way  translation of money resources on the company score through payment systems or through bank by direct payment </r>"
					+ "<r> Account Web Money: 1111222333444 </r>"
					+ "<r> Account Yandex Money: 333442234455 </r>"
	...
	public void addShopWithExtract_en_addcontent( AuthorizationPageBean AuthorizationPageBeanId , String product_id , ServletContext applicationContext) {
		String file_name = "" ;
		String file_path = "" ;
		String query = "";
		long intOwnerUserId  = 0 ;
...
public void addSiteMainSite_pg() {
		...
		try {
			...
			query = "insert into account ( account_id, user_id , amount , curr , date_input ,  description ,  currency_id , complete , active) "
					...
					+ " , "
					+ " NULL , "
					+ "' new_account ', " + "" + currency_id + " " + " ,true , true) ; ";
		...
		dbAdaptor.executeQuery(query);
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria1 (CRETERIA1_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL ) VALUES("+creteria_id+",'РќРµ РІС‹Р±СЂР°РЅРѕ',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№1')" ;
		dbAdaptor.executeUpdate(query);
		...
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria1 (CRETERIA1_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL ) VALUES("+creteria_id+",'РўРµСЃС‚1',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№1')" ;
		dbAdaptor.executeUpdate(query);
		...
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria1 (CRETERIA1_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL ) VALUES("+creteria_id+",'РўРµСЃС‚2',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№1')" ;
		dbAdaptor.executeUpdate(query);
		...
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria2 (CRETERIA2_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL ) VALUES("+creteria_id+",'РќРµ РІС‹Р±СЂР°РЅРѕ',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№2')" ;
		dbAdaptor.executeUpdate(query);
		...
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria3 (CRETERIA3_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL )  VALUES("+creteria_id+",'РќРµ РІС‹Р±СЂР°РЅРѕ',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№3')" ;
		dbAdaptor.executeUpdate(query);
		...
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria4 (CRETERIA4_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL ) VALUES("+creteria_id+",'РќРµ РІС‹Р±СЂР°РЅРѕ',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№4')" ;
		dbAdaptor.executeUpdate(query);
		...
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria5 (CRETERIA5_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL ) VALUES("+creteria_id+",'РќРµ РІС‹Р±СЂР°РЅРѕ',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№5')" ;
		dbAdaptor.executeUpdate(query);
		...
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria6 (CRETERIA6_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL ) VALUES("+creteria_id+",'РќРµ РІС‹Р±СЂР°РЅРѕ',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№6')" ;
		dbAdaptor.executeUpdate(query);
		...
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria7 (CRETERIA7_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL ) VALUES("+creteria_id+",'РќРµ РІС‹Р±СЂР°РЅРѕ',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№7')" ;
		dbAdaptor.executeUpdate(query);
		...
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria8 (CRETERIA8_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL ) VALUES("+creteria_id+",'РќРµ РІС‹Р±СЂР°РЅРѕ',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№8')" ;
		dbAdaptor.executeUpdate(query);
		...
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria9 (CRETERIA9_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL ) VALUES("+creteria_id+",'РќРµ РІС‹Р±СЂР°РЅРѕ',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№9')" ;
		dbAdaptor.executeUpdate(query);
		...
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id.equals("")) creteria_id = "1" ;
		query = "INSERT INTO creteria10 (CRETERIA10_ID ,NAME ,ACTIVE ,LANG_ID ,LINK_ID ,CATALOG_ID ,LABEL ) VALUES("+creteria_id+",'РќРµ РІС‹Р±СЂР°РЅРѕ',TRUE,NULL,0,"+ site_id +",'РљСЂРёС‚РµСЂРёР№10')" ;
		dbAdaptor.executeUpdate(query);
		...
		dbAdaptor.executeUpdate(query);
			...
			query = "insert into soft (soft_id , name , description , fulldescription ,catalog_id , site_id , active ) "
					...
					+ " , "
					+ "'"
					+ " РџРѕРёСЃРєРѕРІР°СЏ СЃРёСЃС‚РµР�?Р° РїРѕСЂС‚Р°Р»Р°  "
					+ "' , "
					+ "'"
					+ "<r>РќР°СЃС‚СЂРѕР№РєР° РїРѕРёСЃРєР° РїРµСЂРµРґ РЅР°С‡Р°Р»РѕР�? </r><r> СЂР°Р±РѕС‚С‹ РїРѕСЂС‚Р°Р»Р° .</r>"
					+ "' , "
			...
			query = "insert into soft (soft_id , name , description , fulldescription ,catalog_id , site_id , active , portlettype_id  ) "
					...
					+ "</r>' , "
					+ "'<r>"
					+ " РќР°Р·РІР°РЅРёРµ РєРѕР�?РїР°РЅРёРё: "
					+ "</r>"
					+ "<r> РўРµР»РµС„РѕРЅ:  </r>"
					+ "<r> Р¤Р°РєСЃ:  </r>"
					+ "<r> РџРѕС‡С‚Р°:  </r>"
	...
	public void addSite(AuthorizationPageBean AuthorizationPageBeanId   ) {
		...
		try {
			...
			args.put("person",AuthorizationPageBeanId.getStrFirstName()  +  " " + AuthorizationPageBeanId.getStrLastName());
			args.put("phone",AuthorizationPageBeanId.getStrPhone() );
			args.put("address",AuthorizationPageBeanId.getStrCountry() + ", " + AuthorizationPageBeanId.getStrCity() + ", " + AuthorizationPageBeanId.getAddress() );
			args.put("active",true );
		...
		dbAdaptor.executeQuery(query);
		creteria_id = dbAdaptor.getValueAt(0, 0);
		if(creteria_id == null || creteria_id.length() == 0) creteria_id = "1" ;
		...
		dbAdaptor.executeInsertWithArgs(query, args);
			...
			args.put("description","<r>РќР°СЃС‚СЂРѕР№РєР° РїРѕРёСЃРєР° РїРµСЂРµРґ РЅР°С‡Р°Р»РѕР�? </r><r> СЂР°Р±РѕС‚С‹ Р�?Р°РіР°Р·РёРЅР° .</r>");
			args.put("fulldescription","<r>1. Р”Р»СЏ РїРѕР»РЅРѕС†РµРЅРЅРѕР№ СЂР°Р±РѕС‚С‹ CMS Business One РІР°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРµС‚ С„РѕСЂР�?Сѓ СЂР°Р·С€РёСЂРµРЅРЅРѕРіРѕ РїРѕРёСЃРєР° РїРѕ РєСЂРёС‚РµСЂРёСЏР�? ,</r>"
					+ "<r> Рё РЅР°СЃС‚СЂРѕРёС‚СЊ РµРµ РїРѕРґ РІР°С€Рё РЅСѓР¶РґС‹ Рё С‡С‚РѕР±С‹ РІР°С€Рё РєР»РёРµРЅС‚С‹ Р�?РѕРіР»Рё СЃСЂР°Р·Сѓ РЅР°С…РѕРґРёС‚СЊ РЅСѓР¶РЅС‹Р№ С‚РѕРІР°СЂ РёР»Рё РёРЅС„РѕСЂР�?Р°С†РёСЋ РёР»Рё РґРѕРєСѓР�?РµРЅС‚С‹ .</r>"
					+ "<r> РІС‹ Р�?РѕР¶Рµ РїРѕСЃР�?РѕС‚СЂРµС‚СЊ РЅР°С€ РІРёРґРµРѕ РєСѓСЂСЃ Р±РµСЃРїР»Р°С‚РЅРѕ РєР°Рє РЅР°СЃС‚СЂРѕРёС‚СЊ С„РѕСЂСѓ СЂР°Р·С€РёСЂРµРЅРЅРѕРіРѕ РїРѕРёСЃРєР°.</r>"
					+ "<r>2. РџРѕРёСЃРє РїРѕ С‚РµРєСЃС‚Сѓ. РџРѕРёСЃРє РїРѕ С‚РµРєСЃС‚Сѓ РЅР°СЃС‚СЂР°РёРІР°С‚СЊ РЅРµ РЅСѓР¶РЅРѕ РѕРЅ СЂР°Р±РѕС‚Р°РµС‚ РїРѕ СѓР�?РѕР»С‡Р°РЅРёСЋ </r>"
					+ "<r>3. РџРѕРёСЃРє РїРѕ РїРµСЂРІРѕР№ Р±СѓРєРІРµ. РџРѕРёСЃРє РїРѕ РїРµСЂРІРѕР№ Р±СѓРєРІРµ РґРѕР±Р°РІР»СЏРµС‚СЊСЃСЏ РїРѕ СЃРѕРіР»Р°СЃРѕРІР°РЅРёСЋ СЃ Р·Р°РєР°Р·С‡РёРєРѕР�?. </r>"
			...
			args.put("description","<r> Р’С‹ РїРѕР»СѓС‡Р°РµС‚Рµ Сѓ РЅР°СЃ С…РѕСЃС‚РёРЅРі СЃ РѕРїР»Р°С‚РѕР№ Р·Р° С‚СЂР°С„РёРє </r>");
			args.put("fulldescription","<r>"
					+ " 1.  Р’С‹ РїРѕР»СѓС‡Р°РµС‚Рµ Р±РµСЃРїР»Р°С‚РЅРѕ РґРѕР�?РµРЅ РІ РЅР°С€РµР№ Р·РѕРЅРµ."
					+ "</r>"
					+ "<r> 2. Р’С‹ Р�?РѕР¶РµС‚Рµ Р·Р°РєР°С‡Р°С‚СЊ Сѓ РЅР°СЃ РїР»Р°С‚РЅРѕ РґРѕР�?РµРЅ РІ Р·РѕРЅРµ com , net , biz , info.  </r>"
					+ "<r> 3. Р’С‹ РїРѕР»СѓС‡Р°РµС‚Рµ Р±РµСЃРїР»Р°С‚РЅРѕ Р�?Р°РіР°Р·РёРЅ .  </r>"
					+ "<r> 4. Р’Р°С€ Р�?Р°РіР°Р·РёРЅ РЅР°С…РѕРґРёС‚СЊСЃСЏ РїРѕ Р°РґСЂРµСЃСѓ http://online-spb.com/Productlist.jsp?site=" + site_id + "  </r>"
					+ "<r> 5. Р’Р°С€ РїРѕС‡С‚РѕРІС‹Р№ СЏС‰РёРє: "+login+"@online-spb.com  </r>"
					+ "<r> РџРѕС‡С‚Р° Р·РґРµСЃСЊ: http://www.online-spb.com/webmail/  </r>"
					+ "<r> Р’С‹ РїРѕР»СѓС‡Р°РµС‚Рµ СЂРµРєР»Р°Р�?РЅСѓСЋ СЃС‚СЂР°РЅРёС†Сѓ РІ РЅР°С€РµР�? Р±РёР·РЅРµСЃ СЃРїСЂР°РІРѕС‡РЅРёРєРµ</r>" );
			args.put("catalog_id",SpecialCatalog.OUTPUT_PAGES_FROM_NEWS_CATALOG );
			...
			args.put("description","<r> Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1 </r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
			...
			args.put("description","<r> РљР°Рє РёР·Р�?РµРЅРёС‚СЊ СЂР°Р·РґРµР» РґР»СЏ РїРѕРёСЃРєР° Р�?РѕРµРіРѕ РёРЅС„РѕР�?Р°С†РёРѕРЅРЅРѕРіРѕ Р�?РѕРґСѓР»СЏ </r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
			...
			args.put("description","<r> Р’С‹ Р�?РѕР¶РµС‚Рµ СѓС‚Р°РЅРѕРІРёС‚СЊ С„Р°РёР» РґР»СЏ СЃРєР°С‡РёРІР°РЅРёСЏ РєР°Рє  РѕРїРёСЃР°РЅРёСЏ С‚РѕРІР°СЂР° РёР»Рё РЅРѕРІРѕСЃС‚Рё Рё РїСЂР°Р№СЃ Р»РёСЃС‚.</r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
			...
			args.put("description","<r> РЎРїР°СЃРёР±Рѕ РѕС‚ Р°РІС‚РѕСЂР° РљРѕРЅСЃС‚Р°РЅС‚РёРЅР° Р“СЂР°Р±РєРѕ С‡С‚Рѕ РІРѕСЃРїРѕР»СЊР·РѕРІР°Р»РёСЃСЊ CMS Business One.</r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
			...
			args.put("description","<r> CMS Business One CMS РїРѕРґРґРµСЂР¶РёРІР°РµС‚ РІСЃРµ С‚РёРїС‹ Р±Р°Р· РґР°РЅРЅС‹С… С‡РµСЂРµР· ejb3 С‚РµС…РЅРѕР»РѕРіРёСЋ.</r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
			...
			args.put("description","<r> CMS Business One CMS РїРѕРґРґРµСЂР¶РёРІР°РµС‚ РІСЃРµ С‚РёРїС‹ СЃРµСЂРІРµСЂРѕРІ РїСЂРёР»РѕР¶РµРЅРёР№ cРїРѕРґРґРµР¶РєРѕР№ J2EE .</r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
			...
			args.put("description","<r> CMS Business One CMS РїРѕРґРґРµСЂР¶РёРІР°РµС‚ С„СѓРЅС†РёРё С…Р°СЂР°РЅРµРЅРёСЏ Рё РїРѕРёСЃРєР° РѕС„РёСЃРЅС‹С… РґРѕРєСѓР�?РµРЅС‚РѕРІ Рё СЃРєР°РЅРёСЂРѕРІР°РЅРЅС‹Рµ РґРѕРєСѓР�?РµРЅС‚С‹ С‚РѕР¶Рµ.</r>");
			args.put("fulldescription","<r>"
					+ "  Р�РЅС„РѕСЂР�?Р°С†РёРѕРЅРЅС‹Р№ Р�?РѕРґСѓР»СЊ РґР»СЏ РіР»Р°РІРЅРѕР№ СЃС‚СЂР°РЅРёС†С‹ 1."
					+ "</r>"
					+ "<r> Р’Р°Р�? РЅСѓР¶РЅРѕ РёР·Р�?РµРЅРёС‚СЊ СЃРѕРґРµСЂР¶Р°РЅРёРµ СЌС‚РѕРіРѕ Р�?РѕРґСѓР»СЏ РЅР° СЃРІРѕРµ  </r>"
			...
			args.put("description","<r> CMS Business One CMS РїРѕРґРґРµСЂР¶РёРІР°РµС‚ GBS Workflow container РґР»СЏ СЂРµР°Р»РёР·Р°С†РёРё РїСЂРѕС…РѕР¶РґРµРЅРёСЏ РґРѕРєСѓР�?РµРЅС‚Р° РїРѕ Р�?Р°СЂС€СЂСѓС‚Сѓ .</r>");
			args.put("fulldescription","<r>"
					+ " CMS Business One CMS РїРѕРґРґРµСЂР¶РёРІР°РµС‚ GBS Workflow container РґР»СЏ СЂРµР°Р»РёР·Р°С†РёРё РїСЂРѕС…РѕР¶РґРµРЅРёСЏ РґРѕРєСѓР�?РµРЅС‚Р° РїРѕ Р�?Р°СЂС€СЂСѓС‚Сѓ ."
					+ "</r>"
					+ "<r> GBS Workflow container РїРѕР·РІРѕР»СЏРµС‚ РѕС‚Р»Р°Р¶РёРІР°С‚СЊ Р�?Р°СЂС€СЂСѓС‚С‹ РЅР° СѓСЂРѕРІРЅРµ Unit С‚РµСЃС‚РёСЂРѕРІР°РЅРёСЏ.  </r>"
			...
			args.put("description","<r> CMS Business One  РїРѕРґРґРµСЂР¶РёРІР°РµС‚ Portlet СЃРїРµС†РёС„РёРєР°С†РёСЋ JSR-286 С‡РµСЂРµР· Pluto Portal Driver.</r>");
			args.put("fulldescription","<r>"
					+ " CMS Business One  РїРѕРґРґРµСЂР¶РёРІР°РµС‚ Portlet СЃРїРµС†РёС„РёРєР°С†РёСЋ JSR-286 С‡РµСЂРµР· Pluto Portal Driver."
					+ "</r>' , "
					+ "'<r>"
			...
			args.put("description","<r> CMS Business One  РїРѕРґРґРµСЂР¶РёРІР°РµС‚ Ajax technology С‡РµСЂРµР· GBS Ajax framework.</r>");
			args.put("fulldescription","<r>"
					+ " CMS Business One  РїРѕРґРґРµСЂР¶РёРІР°РµС‚ Portlet СЃРїРµС†РёС„РёРєР°С†РёСЋ JSR-286 С‡РµСЂРµР· Pluto Portal Driver."
					+ "</r>' , "
					+ "'<r>"
...
//			cretareSiteDirWithExtract(file_name, file_path, site_dir);
	...
	public void cretareSiteDir(String defaultSite, String newSiteDir) {
		try {
			String path = this.getClass().getResource("").getPath();
			path = path.substring(0, path.indexOf("/WEB-INF/"));
			copyDir(path + File.separatorChar + "xsl" + File.separatorChar+ defaultSite, path + File.separatorChar+ "xsl" + File.separatorChar+ newSiteDir);
			copyDir(path + File.separatorChar+ "xsl" + File.separatorChar+ defaultSite + File.separatorChar+ "img", path + File.separatorChar+ "xsl" + File.separatorChar+ newSiteDir + File.separatorChar+ "img");
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		;
