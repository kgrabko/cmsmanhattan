...
public class Calendar_editBean extends com.cbsinc.cms.WebControls implements
	...
	public void editCalendar() {
		...
		query = "update calendar set soft_id = " + product_id
				+ " , holddate = " + holddate + " where calendar_id = "
				+ calendar_id;
