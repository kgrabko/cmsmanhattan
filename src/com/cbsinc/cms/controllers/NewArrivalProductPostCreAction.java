...
@PageController( jspName = "NewArrivalProductPostCre.jsp" ) 
public class NewArrivalProductPostCreAction implements IAction {
	...
	public NewArrivalProductPostCreAction() {
			...
			if (publisherBeanId.getAction().compareTo("save") == 0) {
				...
				if (publisherBeanId.getSoft_id().compareTo("-1") == 0) {
					...
					response.sendRedirect("Productlist.jsp?offset=" + authorizationPageBeanId.getOffsetLastPage()
							+ "&catalog_id=" + authorizationPageBeanId.getCatalogParent_id());
				}
			}
