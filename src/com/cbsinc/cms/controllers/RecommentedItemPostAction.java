...
@PageController( jspName = "RecommentedItemPost.jsp" )
public class RecommentedItemPostAction implements IAction {

	boolean is_criteria_by_catalog = false;
	ProductPostAllFaced productPostAllFaced;
	transient ResourceBundle setup_resources = null;

	public RecommentedItemPostAction() {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response, ServletContext servletContext)
		...
		publisherBeanId.setNameOfPage("RecommentedItemPost.jsp");
