...
@PageController( jspName = "ProductlistMarketPlace.jsp" )
public class ProductlistMarketPlaceAction implements IAction {

	private AuthorizationPageFaced authorizationPageFaced;

	public ProductlistMarketPlaceAction() {
	}
...
//       }
		...
		if (request.getParameter("create_site_by_id") != null) {
			...
			if (authorizationPageBeanId.getUser_site().equals("-1")) {
				...
				// messageMail.put("@Shop", "http://www.siteforyou.net/ProductlistMarketPlace.jsp?site=" +
			...
			// authorizationPageFaced.getCreateShopBean().getLogin()+ "&Passwd1=" +
			// authorizationPageFaced.getCreateShopBean().getPasswd() );
			response.sendRedirect("ProductlistMarketPlace.jsp?action=login_usersite");
			return;
		}
		...
		if (productlistBeanId.getAction().compareTo("login_usersite") == 0) {
			...
			if (authorizationPageBeanId.getUser_site().compareTo("-1") != 0) {
				...
				if (authorizationPageFaced.isLoginCorrect(authorizationPageBeanId.getStrLogin(),
					...
					// response.sendRedirect("ProductlistMarketPlace.jsp?offset=0" );
					// servletContext.getRequestDispatcher("/ProductlistMarketPlace.jsp?offset=0").forward(
					// request, response);
					productlistBeanId.setOffset(0);
				}
			} else
...
///////+++//
		...
		if (productlistBeanId.getAction().compareTo("logoff") == 0
			...
			response.sendRedirect(
					"ProductlistMarketPlace.jsp?site=" + site_id + "&" + "locale=" + authorizationPageBeanId.getLocale());
			// servletContext.getRequestDispatcher("/ProductlistMarketPlace.jsp?site=" + site_id + "&"
		...
		productlistBeanId.recommentedItems = productlistFaced.getRecommentedItems( authorizationPageBeanId.getIntUserID(),
				authorizationPageBeanId.getSite_id(), authorizationPageBeanId.getCatalog_id(), productlistBeanId,
				authorizationPageBeanId);
		productlistBeanId.sponsoredBySellers = productlistFaced.getSponsoredBySellersItems( authorizationPageBeanId.getIntUserID(),
				authorizationPageBeanId.getSite_id(), authorizationPageBeanId.getCatalog_id(), productlistBeanId,
				authorizationPageBeanId);
		productlistBeanId.newArrivalItems = productlistFaced.getNewArrivalItems( authorizationPageBeanId.getIntUserID(),
				authorizationPageBeanId.getSite_id(), authorizationPageBeanId);
		productlistBeanId.topItemReview = productlistFaced.getTopItemsReview(authorizationPageBeanId.getSite_id(),
				productlistBeanId, authorizationPageBeanId);
		...
		productlistBeanId.setSelect_currency_cd(productlistFaced.getXMLDBList("ProductlistMarketPlace.jsp?currency_cd",
				"currencies", productlistBeanId.getCurrency_cd(),
				"SELECT currency_cd , currency_desc  FROM currency  WHERE active = true"));
		productlistBeanId.setSelect_tree_catalog(productlistFaced.getTreeXMLDBList("ProductlistMarketPlace.jsp?catalog_id",
		...
		productlistBeanId.setSelect_menu_catalog(productlistFaced.getMenuXMLDBList("ProductlistMarketPlace.jsp?catalog_id", "menu",
				authorizationPageBeanId.getCatalog_id(),
		...
		productlistBeanId.setSelect_dayfrom_id(productlistFaced.getXMLListDateDay("ProductlistMarketPlace.jsp?dayfrom_id",
				"dayfrom", "" + authorizationPageBeanId.getDayfrom_id()));
		productlistBeanId.setSelect_mountfrom_id(productlistFaced.getXMLListDateMount("ProductlistMarketPlace.jsp?mountfrom_id",
				"mountfrom", "" + authorizationPageBeanId.getMountfrom_id()));
		productlistBeanId.setSelect_yearfrom_id(productlistFaced.getXMLListDateYear("ProductlistMarketPlace.jsp?yearfrom_id",
				"yearfrom", "" + authorizationPageBeanId.getYearfrom_id()));

		productlistBeanId.setSelect_dayto_id(productlistFaced.getXMLListDateDay("ProductlistMarketPlace.jsp?dayto_id", "dayto",
				"" + authorizationPageBeanId.getDayto_id()));
		productlistBeanId.setSelect_mountto_id(productlistFaced.getXMLListDateMount("ProductlistMarketPlace.jsp?mountto_id",
				"mountto", "" + authorizationPageBeanId.getMountto_id()));
		productlistBeanId.setSelect_yearto_id(productlistFaced.getXMLListDateYear("ProductlistMarketPlace.jsp?yearto_id", "yearto",
