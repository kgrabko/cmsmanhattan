...
@PageController( jspName = "SponsoredBySellersItemPost.jsp" )
public class SponsoredBySellersItemPostAction implements IAction {

	boolean is_criteria_by_catalog = false;
	ProductPostAllFaced productPostAllFaced;
	transient ResourceBundle setup_resources = null;

	public SponsoredBySellersItemPostAction() {
