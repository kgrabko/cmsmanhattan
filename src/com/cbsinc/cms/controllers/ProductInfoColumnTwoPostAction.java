...
@PageController( jspName = "ProductInfoColumnTwoPost.jsp" )
public class ProductInfoColumnTwoPostAction implements IAction {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response, ServletContext servletContext)
		...
		publisherBeanId.setNameOfPage("Ext2ProductPost.jsp");
		if (jsf_admin)
