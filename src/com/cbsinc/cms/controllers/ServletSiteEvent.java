...
//		String lastPage = request.getQueryString() ;
		...
		if(!(se.getSession().getAttribute("AuthorizationPageBeanId") instanceof AuthorizationPageBean)) return ;
		AuthorizationPageBean AuthorizationPageBeanId = (AuthorizationPageBean)se.getSession().getAttribute("AuthorizationPageBeanId");
		...
		if(!(servletContext.getAttribute("userlist") instanceof HashMap)) return ;
