...
public class ShopHome {
	...
	public Shop merge(Shop detachedInstance) {
		...
		try {
			Shop result = (Shop) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Shop findById(java.lang.Long id) {
		...
		try {
			Shop instance = (Shop) sessionFactory.getCurrentSession().get(
					"com.cbsinc.entity.Shop", id);
			if (instance == null) {
	...
	public List findByExample(Shop instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.cbsinc.entity.Shop")
