...
/**
 * Home object for domain model class Basket.
 * @see com.cbsinc.entity.Basket
 * @author Hibernate Tools
 */
public class BasketHome {

	private static final Log log = LogFactory.getLog(BasketHome.class);
	...
	public void persist(Basket transientInstance) {
		log.debug("persisting Basket instance");
		try {
	...
	public Basket merge(Basket detachedInstance) {
		...
		try {
			Basket result = (Basket) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Basket findById(long id) {
		...
		try {
			Basket instance = (Basket) sessionFactory.getCurrentSession().get(
					"com.cbsinc.entity.Basket", id);
			if (instance == null) {
	...
	public List findByExample(Basket instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.cbsinc.entity.Basket")
